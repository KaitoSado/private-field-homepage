...
function classifyPos(word, meaning, forcePhrase) {
  ...
  const explicit = meaning.match(/\[(名|自|他|形|副|前|接|代|助)\]/);
  if (explicit) {
    return {
      pos: {
        名: "noun",
